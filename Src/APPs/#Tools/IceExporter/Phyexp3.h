...
#define HIERARCHIAL_VERTEX	0x0001
#define FLOATING_VERTEX		0x0002
...
// NOTE: for Character Studio 3.0 an ADD Change feature has been added to physique as an
// additional way to handle changes in the stack.  This feature is NOT supported in the SDK
// You will need to use the Remap Local option, which in most cases will give you nearly
// identical results
...
class IPhyBlendedRigidVertex : public IPhyVertexExport
{
	public:
		...
		PHYExport virtual float GetWeight(int i, float *totalweight = NULL) = 0;
...
class IPhyContextExport
{
	public:
		...
		PHYExport virtual IPhyVertexExport *GetVertexInterface(int i, const int type = HIERARCHIAL_VERTEX) = 0;
