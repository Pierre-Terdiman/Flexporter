...
//							mPos *= TmpMat;
							...
							// Same but faster:
							Matrix3x3 TmpMat = father_pr.mRot;
							float xp = mPos.x * TmpMat.m[0][0] + mPos.y * TmpMat.m[1][0] + mPos.z * TmpMat.m[2][0] + father_pr.mPos.x;
							float yp = mPos.x * TmpMat.m[0][1] + mPos.y * TmpMat.m[1][1] + mPos.z * TmpMat.m[2][1] + father_pr.mPos.y;
							float zp = mPos.x * TmpMat.m[0][2] + mPos.y * TmpMat.m[1][2] + mPos.z * TmpMat.m[2][2] + father_pr.mPos.z;
							mPos.x = xp;
							mPos.y = yp;
							mPos.z = zp;
/*
