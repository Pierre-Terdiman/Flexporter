...
//udword mCounter;
	...
	#define IMPLEMENT_COLLISION_TREE(base_class, node)																\
		...
		/* Saves the tree */																						\
		override(AABBOptimizedTree)	bool			Save(CustomArray& array)	const;								\
		/* Loads the tree */																						\
		override(AABBOptimizedTree)	bool			Load(const CustomArray& array);									\
		/* Data access */																							\
	...
	class OPCODE_API AABBOptimizedTree : public OpcodeAllocated
	{
		public:
		// Constructor / Destructor
											AABBOptimizedTree() :
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual			bool				Save(CustomArray& array)		const							= 0;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual			bool				Load(const CustomArray& array)									= 0;
