		...
		inline_			void				GetTriangle(VertexPointers& vp, udword index)	const
											{
												...
												vp.Vertex[0] = (const Point*)(((ubyte*)mVerts) + T->mRef[0] * mVertexStride);
												vp.Vertex[1] = (const Point*)(((ubyte*)mVerts) + T->mRef[1] * mVertexStride);
												vp.Vertex[2] = (const Point*)(((ubyte*)mVerts) + T->mRef[2] * mVertexStride);
	#else
												const IndexedTriangle* T = &mTris[index];
												vp.Vertex[0] = &mVerts[T->mRef[0]];
												vp.Vertex[1] = &mVerts[T->mRef[1]];
												vp.Vertex[2] = &mVerts[T->mRef[2]];
	#endif
#endif
											}
