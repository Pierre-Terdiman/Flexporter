...
//		float		FatRadius2;	//!< LSS used when performing the query resulting in cached faces
		// User settings
	...
	class OPCODE_API LSSCollider : public VolumeCollider
	{
		...
		// LSS in model space
							...
							Point			mSDir;			//!< Precomputed segment data
							Point			mFDir;			//!< Precomputed segment data
							Point			mSCen;			//!< Precomputed segment data
