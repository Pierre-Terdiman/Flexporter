...
#define OPC_RAYCOLLIDER_H
	...
	class OPCODE_API HybridRayCollider : public RayCollider
	{
		...
		// Internal methods
							void			_SegmentStabNPT(const AABBCollisionNode* node);
							void			_SegmentStabNPT(const AABBNoLeafNode* node);
							void			_SegmentStabNPT(const AABBQuantizedNode* node);
							void			_SegmentStabNPT(const AABBQuantizedNoLeafNode* node);
							void			_RayStabNPT(const AABBCollisionNode* node);
							void			_RayStabNPT(const AABBNoLeafNode* node);
							void			_RayStabNPT(const AABBQuantizedNode* node);
							void			_RayStabNPT(const AABBQuantizedNoLeafNode* node);
	};
