...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Include Guard
#ifndef OPC_TREECOLLIDER_H
#define OPC_TREECOLLIDER_H
					...
					void	ResetCache()
							{
								...
								id0				= 0;
								id1				= 1;
#ifdef MESHMERIZER_H		// Collision hulls only supported within ICE !
								HullTest		= true;
								SepVector.pid	= 0;
								SepVector.qid	= 0;
...
#ifdef NOVODEX_VERSION
	//by Adam -- contact return code:
	typedef bool (*BoxBoxCallback)  (const CollisionAABB & a,const CollisionAABB & b);
#endif
...
#ifdef NOVODEX_VERSION
		// new custom box based code by Adam:
							bool			Collide(BoxBoxCallback, int targetLevel, const Model* model0, const Model* model1, const Matrix4x4* world0=null, const Matrix4x4* world1=null);
#endif
		// Settings
...
#ifdef SEPARATION_LINE
Container mSepLine0, mSepLine1;
Container* mCurLine;
Container* mOldLine;
#endif
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#ifdef NOVODEX_VERSION
			// Adam's special no-leaf trees
			inline_			void			PrimTestTriIndexNoRecord(udword id1);
			inline_			void			PrimTestIndexTriNoRecord(udword id0);
							void			_CollideTriBox(const AABBNoLeafNode* b, BoxBoxCallback cb, int levelsUntilBoxBox, const AABBNoLeafNode* other);
							void			_CollideBoxTri(const AABBNoLeafNode* b, BoxBoxCallback cb, int levelsUntilBoxBox, const AABBNoLeafNode* other);
							void			_Collide(const AABBNoLeafNode* a, const AABBNoLeafNode* b, BoxBoxCallback cb, int  levelsUntilBoxBox);
#endif
			// Standard AABB trees
