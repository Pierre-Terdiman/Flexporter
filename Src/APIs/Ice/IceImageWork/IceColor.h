...
#define ICECOLOR_H
	...
	{
		udword r = (udword)(127.0f * v.x + 128.0f);
		udword g = (udword)(127.0f * v.y + 128.0f);
		udword b = (udword)(127.0f * v.z + 128.0f);
	...
	class ICEIMAGEWORK_API RGBPixel
	{
		public:
		//! Constructor
		inline_					RGBPixel()								{}
	...
	class ICEIMAGEWORK_API RGBAPixel : public RGBPixel
	{
		...
		inline_					RGBAPixel()													{}
		//! Constructor
		inline_					RGBAPixel(ubyte r, ubyte g, ubyte b, ubyte a=PIXEL_OPAQUE)	{ R=r; G=g; B=b; A=a;		}
		//! Constructor
	...
	class ICEIMAGEWORK_API RGBAColor
	{
		public:
		//! Constructor
		inline_					RGBAColor()												{}
		//! Constructor
		inline_					RGBAColor(float _r, float _g, float _b, float _a=1.0f)	{ R=_r; G=_g; B=_b; A=_a;	}
		//! Constructor
