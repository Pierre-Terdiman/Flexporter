...
#define ICEDECAL_H
	...
	class MESHMERIZER_API Decal
	{
		...
		public:
				...
				TexCoords		mTexcoordArray[gMaxDecalVertices];
		...
		static	long			ClipPolygonAgainstPlane(const HPoint& plane, long vertex_count, const Point* vertex, const Point* normal, Point* new_vertex, Point* new_normal);
	};
